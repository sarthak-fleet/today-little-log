export const MEMENTO_QUOTES: { text: string; source?: string }[] = [
  ...
  {
    text: 'Time is the substance from which I am made. Time is a river which sweeps me along, but I am the river.',
    source: 'Borges',
  },
  { text: 'The two most powerful warriors are patience and time.', source: 'Tolstoy' },
  {
    text: 'Every minute you spend on something you hate is a minute stolen from something you love.',
    source: '—',
  },
