  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 text-sm leading-7">
      ...
      <p className="mt-2 text-muted-foreground">
        Download a single JSON file with every row scoped to your account &mdash;
        scoreboard items + logs, habits + habit logs, tasks, journal, daily
        check-ins, weekly reviews, the lot. Useful as a backup, or if you ever
        want to leave.
      </p>
      <div className="mt-3 flex items-center gap-3">
        ...
        {exportState === "ok" && (
          <span className="text-xs text-emerald-500">Downloaded.</span>
        )}
